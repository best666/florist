...
CREATE TABLE `florist`.`TaxonomyItem` (
  ...
  CONSTRAINT `TaxonomyItem_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `florist`.`User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
